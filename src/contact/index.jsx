        ...
        <div className="contact-box">
          <div className="left-container contact-container-fb">
            <div className="left-box">
              {location.pathname==="/contact/"?<Carousel CarouselImage={CoupleCarouselImage}/>:location.pathname==="/contact/event"?<Carousel CarouselImage={eventCarouselImage}/>:<Carousel CarouselImage={editorialCarouselImage}/>}
            </div>
          </div>
          <div className="right-container contact-container-fb">
            <div className="right-box">
              <div className="right-inner-box">
                ...
                <div className="contact-desc">
                  <p>
                    ...
                    you! Please fill out the form below or send a note directly
                    to info@lerevefilms.com
                  </p>
                </div>
              </div>
              ...
              <div className="forms">
                {location.pathname==="/contact/"?<Couple/>:location.pathname==="/contact/event"?<EventPlanner/>:location.pathname==="/contact/editorial"?<Editorial/>:""}
              </div>
            </div>
          </div>
        </div>
